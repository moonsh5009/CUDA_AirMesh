...
static __inline__ __host__ __device__ REAL2 operator+(const REAL2 a, const REAL2 b)
{
...
static __inline__ __host__ __device__ REAL operator*(const REAL2 a, const REAL2 b)
{
	return a.x * b.x + a.y * b.y;
}
static __inline__ __host__ __device__ REAL2 operator+(const REAL2 a, const REAL b)
{
...
static __inline__ __host__ __device__ REAL2 operator*(const REAL b, const REAL2 a)
{
	return make_REAL2(a.x * b, a.y * b);
}
static __inline__ __host__ __device__ REAL2 operator/(const REAL b, const REAL2 a)
...
static __inline__ __host__ __device__ void operator+=(REAL2 & a, const REAL2 b)
{
	a.x += b.x;
	a.y += b.y;
}
...
static __inline__ __host__ __device__ void operator+=(REAL2 & a, const REAL b)
{
	a.x += b;
	a.y += b;
}
...
static __inline__ __host__ __device__ REAL LengthSquared(const REAL2 a)
{
	return a * a;
}
...
static __inline__ __host__ __device__ REAL Length(const REAL2 a)
{
	return sqrt(a * a);
}
...
static __inline__ __host__ __device__ bool Normalize(REAL2 & a)
{
	REAL norm = Length(a);
	if (norm == 0) {
		//printf("Error Normalize Length 0\n"); 
...
static __inline__ __host__ __device__ REAL Dot(REAL2 a, REAL2 b)
{
	return a.x * b.x + a.y * b.y;
}
static __inline__ __host__ __device__ REAL Cross(REAL2 a, REAL2 b)
{
